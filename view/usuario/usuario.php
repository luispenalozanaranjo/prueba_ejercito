    ...
    <?php foreach($this->model->Listar() as $r): ?>
        <tr>
         <td><?php echo $r->NOMBREUSUARIO.' '.$r->APELLIDOUSUARIO; ?></td>
            ...
            <?php } else {?>
			   <a  class="btn btn-danger" onclick="javascript:return confirm('¿Desea Ocultar este Registro?, Si realiza esta accion, quedara guardado en la base de datos');" href="?c=usuario&a=Ocultar&IDUSUARIO=<?php echo $r->IDUSUARIO; ?>">Ocultar</a>
			<?php } ?>
			</td>
        </tr>
    <?php endforeach; ?>
