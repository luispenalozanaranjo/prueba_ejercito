...
<form id="frm-alumno" action="?c=usuario&a=Guardar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label>Nombre</label>
        <input type="text" name="NOMBREUSUARIO" value="<?php echo $usuario->NOMBREUSUARIO; ?>" class="required NOMBREUSUARIO form-control" placeholder="Ingrese su nombre" onkeypress="return soloLetras(event)">
    </div>
    
    <div class="form-group">
        <label>Apellido</label>
        <input type="text" name="APELLIDOUSUARIO" value="<?php echo $usuario->APELLIDOUSUARIO; ?>" class="required APELLIDOUSUARIO form-control" placeholder="Ingrese su apellido" onkeypress="return soloLetras(event)">
    </div>
